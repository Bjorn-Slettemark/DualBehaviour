...
public class GameStateManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        EventChannelManager.Instance.SubscribeToChannel("GameStateChannel", eventCheck);
    ...
    {
        EventChannelManager.Instance.UnsubscribeFromChannel("GameStateChannel", eventCheck);
        if (Instance == this)
        {
